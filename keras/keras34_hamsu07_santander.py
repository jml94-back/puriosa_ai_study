...
dense4 = Dense(512)(drop3)
drop4= Dropout(0.4)(dense4)
dense5 = Dense(512, activation="relu")(drop4)
drop5= Dropout(0.3)(dense5)

dense6 = Dense(512, activation="relu")(drop5)
drop6= Dropout(0.2)(dense6)
dense7 = Dense(512, activation="relu")(drop6)
drop7= Dropout(0.3)(dense7)
dense8 = Dense(512)(drop7)

output1 = Dense(2, activation="softmax")(drop6)
