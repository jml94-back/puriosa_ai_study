...
#1. 데이터
x1 = np.array([ random.randrange(100, 1000) for s in range(10000)])
x2 = np.array([ random.randrange(100, 1000) for s in range(10000)])
x3 = np.array([ random.randrange(100, 1000) for s in range(10000)])

y = np.array([ x1[i]*x2[i]*x3[i] for i in range(10000)])
...
#2. 모델
model = Sequential([keras.Input(shape=(3,))])
